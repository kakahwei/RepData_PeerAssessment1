...
## The code above run well in window 8 , if you encounter any error , you may download the zip file manually  , enable the code below (remove ##) , set the working directory to the .zip file location and set the activityDs.
...
*Total number of missing values in the dataset : `r sumOfNA`*
